  ...
  public function Send() {
    try {
      ...
      if ($this->debugMode===true) {
          file_put_contents('tmp/m_'.str_replace(' ','_',$this->FromName)."_".date("d.m.Y_His").".txt",$this->MIMEHeader.$this->LE.$this->MIMEBody);
          return true;
      }
      ...
      $this->mailHeader = '';
      $ms = $e->getMessage();
      file_put_contents('tmp/m_err_'.date("d.m.Y_His").".log",$ms,FILE_APPEND);
      $this->SetError($ms);
      if ($this->exceptions) {
        throw $e;
      }
